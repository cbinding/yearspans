...
class TestYearSpanMatcherCS(unittest.TestCase):
    ...
    def test_matchMonthYearAD(self):
        ...
        expected = "1066/1066"
        self.assertTrue(span is not None, msg="span is None")
        if span is not None: self.assertEqual(expected, span.toISO8601())
    ...
    def test_matchSeasonYearBP(self, msg="span is None"):
    ...
    def test_matchYearWithTolerance1(self):
        ...
        expected = "1575/1617"
        self.assertTrue(span is not None, msg="span is None")
        if span is not None: self.assertEqual(expected, span.toISO8601(), msg=f"span=\"{span.toISO8601()}\"")
